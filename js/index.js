...
var model = {
  ...
  "GTAV MENUS": {
	...
	"ABOUT": {
      ...
      active: false,
      icon: "help",
      items: [{title: "◄ PS4 Self-Exploit Host (OFW 5.05 Only) ►", desc:"March 2019", version: "v1.5.5 Edited and Translated by SCORPION, X-PROJECT by DEFAULTDNB", active: false, icon: "fingerprint"}]
    },
	"★DEBUG": {
      index: 14,
      title: "★DEBUG",
