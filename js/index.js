...
var model = {
  ...
  "GTAV MENUS": {
	...
	"MEDIA": {
      ...
      active: false,
      icon: "subscriptions",
      items: [{title: "MP4PLAYER", desc:"« ابزار Media Player که فایلهای MP4 را از طریق شبکه اجرا می نماید »", version: "1.0 by DEFAULTDNB", active: false, icon: "airplay", expage: "1" }]
	},
	"CACHE": {
      index: 12,
      title: "ذخیره سازی",
	...
	"ABOUT": {
      ...
      active: false,
      icon: "help",
      items: [{title: "◄ PS4 Self-Exploit Host (OFW 5.05 Only) ►", desc:"March 2019", version: "v1.5.0 Translate by SCORPION, X-PROJECT by DEFAULTDNB", active: false, icon: "fingerprint"}]
    },
	"★DEBUG": {
      index: 14,
      title: "★DEBUG",
