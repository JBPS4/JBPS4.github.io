...
var model = {
  ...
  columns: {
	 "QUICK": {
      ...
      active: false,
      icon: 'style',
      items: [{ title: "HEN 1.9", desc: "« پی لود HEN (اختصار برای Homebrew ENabler) که امکان نصب و اجرای بازیهای بصورت fPKG را فراهم میکند »", version: "1.9 by SiSTRo", active: false, icon: "lock", expage: "payloads/vtxhen19.html" }, { title: "HEN 1.8", desc: "« پی لود HEN (اختصار برای Homebrew ENabler) که امکان نصب و اجرای بازیهای بصورت fPKG را فراهم میکند »", version: "1.8 by Zecoxao", active: false, icon: "", expage: "payloads/vtxhen18.html" }, { title: "Pure HEN", desc: "« ترکیب سبکی از HEN 1.8 و HEN VR »", version: "1.8 by DEFAULTDNB & LEEFUL", active: false, icon: "lock", expage: "payloads/henpure.html" },  { title: "BINLOADER", desc: "« فعالسازی BINLOADER از طریق پورت 9020 »", version: "1.7 by OpenOrbisTeam", active: false, icon: "send", expage: "payloads/binloader.html" }, { title: "DUMPER", desc: "« پی لود Dumper که امکان تهیه دامپ یا بکاپ از دیسک بازی و یا عناوین دیجیتالی PS4 را فراهم میکند »", version: "1.8 by xVortex", active: false, icon: "archive", expage: "payloads/vtxdump.html"}, { title: "FTP SERVER", desc: "« پی لود FTP که بستر ارتباطی لازم جهت اتصال کنسول و کامپیوتر را از طریق پروتکل FTP فراهم می سازد »", version: "1.3 by xVortex", active: false, icon: "wifi", expage: "payloads/vtxftp.html"}]
    },
    "HEN": {
      index: 1,
      title: "پکیج HEN",
